...
namespace FCRA.Repository.Migrations
{
    ...
    [Migration("20230714104441_UpdateSqlObjects")]
    partial class UpdateSqlObjects
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FCRA.Models.Account.FormMaster", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Action = "Index",
                            Area = "Admin",
                            Controller = "RiskAssessmentVersion",
                            IconClass = "fas fa-comment-dots",
                            IsAdmin = true,
                            MenuId = 2,
                            Name = "Risk Assessment Version",
                            Sequence = 7
                        },
                        new
                        {
            ...
            modelBuilder.Entity("FCRA.Models.Account.RolePermissions", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Add = true,
                            Edit = true,
                            FormName = "Customer Configuration",
                            View = true
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            Add = true,
                            Edit = true,
                            FormName = "Risk Assessment Version",
                            View = true
                        },
                        new
                        {
            ...
            modelBuilder.Entity("FCRA.Models.Customers.CustomerConfiguration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("CustomerConfiguration");
            ...
            modelBuilder.Entity("FCRA.Models.DataAuditTrail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FCRA.Models.Masters.ApprovalHistory", b =>
                {
                    ...
                    b.Property<int>("PendingWithUser")
                        .HasColumnType("int")
                        .HasColumnOrder(6);
            ...
            modelBuilder.Entity("FCRA.Models.Masters.ApprovalMatrix", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FCRA.Models.Masters.CustomerVersionMaster", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("CustomerVersionMaster");
                });
            ...
            modelBuilder.Entity("FCRA.Models.Responses.ApprovedRiskFactorResponse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ApprovedRiskFactorResponse");
                });

            modelBuilder.Entity("FCRA.Models.Responses.ApprovedRiskScoreProductVolumRatingResponse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ApprovedRiskScoreProductVolumRatingResponse");
                });

            modelBuilder.Entity("FCRA.Models.Responses.ApprovedRiskScoreResponse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ApprovedRiskScoreResponse");
                });

            modelBuilder.Entity("FCRA.Models.Responses.ApprovedRiskSubFactorAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ApprovedRiskSubFactorAttachment");
                });

            modelBuilder.Entity("FCRA.Models.Responses.ApprovedRiskSubFactorResponse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ApprovedRiskSubFactorResponse");
                });

            modelBuilder.Entity("FCRA.Models.Responses.ApprovedRiskSubFactorVolumeResponse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ApprovedRiskSubFactorVolumeResponse");
                });
            ...
            modelBuilder.Entity("FCRA.Models.RiskSubFactor", b =>
                {
                    ...
                    b.Property<bool>("isAttachmentApplicable")
                        .HasColumnType("bit")
                        .HasColumnOrder(29);

                    b.Property<bool>("isAttachmentMandatory")
                        .HasColumnType("bit")
                        .HasColumnOrder(30);
